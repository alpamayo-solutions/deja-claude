...
def tmp_claude_dir(tmp_path):
    ...
    _write_session(
        ...
        [
            ...
            _assistant_msg_with_tool(
                "Bash", {"command": "python manage.py runserver"}, "2026-03-01T09:00:15Z"
            ),
    ...
    history_lines = [
        json.dumps(
            {
                "display": "How do I add a login page?",
        ...
        json.dumps(
            {
                "display": "Fix the CSS on the navbar",
                "sessionId": "aaaa2222-0000-0000-0000-000000000002",
                "project": "/Users/test/Projects/myapp",
                "timestamp": 1739624400000,
            }
        ),
    ]
